    ...
    <div className="min-h-screen dreamy-bg">
      ...
      <nav className="bg-white/80 backdrop-blur-sm py-4 px-6 shadow-sm sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          <div className="w-10 h-10 flex items-center justify-center rounded-full border-2 border-emcee-darkPink bg-emcee-white text-black font-playfair text-lg font-bold shadow-sm">JK</div>
          ...
          <div className="md:hidden">
            <button onClick={toggleMenu} className="text-emcee-darkGray focus:outline-none">
